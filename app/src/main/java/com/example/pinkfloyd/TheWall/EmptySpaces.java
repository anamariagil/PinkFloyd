...
public class EmptySpaces extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bprevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent previous = new Intent(EmptySpaces.this, GoodbyeBlueSky.class);
        ...
        bnext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent next = new Intent(EmptySpaces.this, YoungLust.class);
                startActivity(next);
            }
        });
        ...
        bhome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent home = new Intent(EmptySpaces.this, TWHome.class);
                startActivity(home);
            }
        });
    }
